...
- **시연 이미지**:
  (https://user-images.githubusercontent.com/con-stella/pilot/blob/main/people_counts_screenshot.png)
    (https://user-images.githubusercontent.com/yourusername/people_counts_screenshot.png)
